...
import { useGetRegionQuery } from "../../redux/features/regionArea/regionAreaApi";
...
function Region() {
  ...
  const { data, isLoading, isSuccess } = useGetRegionQuery(number);
          ...
          <div className="flex w-full flex-col">
            <div className="mt-20 px-6 py-6 bg-[#F8F8FB] w-full h-full">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-lg font-bold">Region List</h3>
                ...
                {dataList && dataList.length === 0 && (
                  <div className="flex justify-center items-center flex-col gap-8 h-full">
                    ...
                    <p className="text-sm text-center font-normal w-[220px] text-[#9FA3A6]">
                      ...
                      <Link to="/createRegion" className="text-[#556EE6]">
                        Create Region
                      </Link>
                    </p>
                  </div>
